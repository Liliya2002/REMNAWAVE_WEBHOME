    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark via-surface to-dark p-4">
      <div className="max-w-md w-full bg-surface/80 backdrop-blur-sm border border-green-500/30 rounded-2xl p-6 sm:p-8 text-center shadow-2xl">
        <div className="mb-6">
          ...
          <p className="text-slate-300">Ваша подписка активирована</p>
        </div>

        <div className="space-y-4">
          <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-lg text-left">
            <p className="text-sm text-slate-300 mb-2 flex items-center gap-2"><Sparkles className="w-4 h-4 text-yellow-400 shrink-0" /> Подписка активирована и готова к использованию</p>
            <p className="text-sm text-slate-300 mb-2 flex items-center gap-2"><Link2 className="w-4 h-4 text-blue-400 shrink-0" /> Данные для подключения доступны в личном кабинете</p>
            <p className="text-sm text-slate-300 flex items-center gap-2"><Mail className="w-4 h-4 text-green-400 shrink-0" /> Детали отправлены на вашу почту</p>
          </div>
