...
export default function Landing() {
  ...
  return (
    <div className="w-full bg-sky-50 dark:bg-slate-900 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      {/* Hero Section */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-full mb-6 sm:mb-8 hover:border-blue-500/40 transition-colors">
              ...
              <span className="text-xs sm:text-sm text-blue-700 dark:text-blue-300">Защита мирового уровня</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 sm:mb-6 leading-tight">
              ...
              <br />
              <span className="text-sky-700 dark:text-slate-300">{heroSubtitle}</span>
            </h1>

            {/* Subheading */}
            <p className="max-w-2xl mx-auto text-base sm:text-lg lg:text-xl text-sky-700 dark:text-slate-400 dark:text-slate-400 mb-6 sm:mb-8">
              Высокая скорость, шифрование AES-256, серверы в 150+ странах и поддержка всех устройств.
              Начните всего за <span className="text-blue-600 dark:text-blue-400 font-semibold">10 рублей</span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-10 sm:mb-16">
              ...
              <button
                onClick={() => navigate('/pricing')}
                className="px-6 sm:px-8 py-3 sm:py-4 border border-slate-600 text-sky-700 dark:text-slate-300 font-bold rounded-lg hover:border-blue-500 hover:text-blue-300 transition-all duration-300"
              >
                Выбрать тариф
              </button>
            </div>
            ...
            {/* Metrics Bar */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 py-6 sm:py-12 border-t border-b border-sky-200 dark:border-slate-800/50">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  150+
                </div>
                <div className="text-xs sm:text-sm text-sky-700 dark:text-slate-400 dark:text-slate-400">Стран</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  10 Гбит/с
                </div>
                <div className="text-xs sm:text-sm text-sky-700 dark:text-slate-400 dark:text-slate-400">Макс скорость</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  &lt;20мс
                </div>
                <div className="text-xs sm:text-sm text-sky-700 dark:text-slate-400 dark:text-slate-400">Задержка</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  99.9%
                </div>
                <div className="text-sm text-sky-700 dark:text-slate-400 dark:text-slate-400">Доступность</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Features Section */}
      <section className="py-12 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-sky-50 dark:bg-slate-900/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">Почему выбирают нас</h2>
            <p className="text-sky-700 dark:text-slate-400 dark:text-slate-400">Лучшие технологии для вашей безопасности</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              {
                icon: <Lock className="w-9 h-9 text-blue-600 dark:text-blue-400" />,
                title: 'Военное шифрование',
                description: 'AES-256 и OpenVPN/WireGuard защищают ваши данные от утечек'
              },
              {
                icon: <Zap className="w-9 h-9 text-yellow-600 dark:text-yellow-400" />,
                title: 'Максимальная скорость',
                description: 'Серверы оптимизированы для работы без снижения пропускной способности'
              },
              {
                icon: <Globe className="w-9 h-9 text-green-600 dark:text-green-400" />,
                title: 'Глобальные серверы',
                description: 'Подключайтесь через серверы в 150+ странах в один клик'
              },
              {
                icon: <Smartphone className="w-9 h-9 text-purple-600 dark:text-purple-400" />,
              ...
              <div
                key={i}
                className="p-5 sm:p-6 lg:p-8 bg-sky-50 dark:bg-slate-900 dark:bg-gradient-to-br dark:from-slate-800/50 dark:to-slate-900/50 border border-sky-200 dark:border-slate-700/50 rounded-xl hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300"
              >
                <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">{typeof feature.icon === 'string' ? feature.icon : feature.icon}</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-sky-900 dark:text-slate-100">{feature.title}</h3>
                <p className="text-sm sm:text-base text-sky-700 dark:text-slate-400 dark:text-slate-400">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-sky-700 dark:text-slate-400 dark:text-slate-400">Простой и быстрый процесс для новичков</p>
          </div>
              ...
              <div key={i} className="relative">
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center mb-4">
                    <span className="text-2xl font-bold text-sky-900 dark:text-white">{step.num}</span>
                  </div>
                  <h3 className="text-lg font-bold mb-2">{step.title}</h3>
                  <p className="text-sm text-sky-700 dark:text-slate-400 dark:text-slate-400">{step.desc}</p>
                </div>
                {i < 3 && (
      ...
      <section className="py-12 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-sky-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-sky-700 dark:text-slate-400 dark:text-slate-400">Лучшие цены на рынке</p>
          </div>
              ...
              <div
                ...
                className={`flex justify-between items-center p-4 rounded-lg border transition-all ${
                  item.highlight
                    ...
                    : 'bg-sky-100/60 dark:bg-slate-800/30 border-sky-200 dark:border-slate-700/30'
                }`}
              >
                <span className={item.highlight ? 'font-bold text-blue-700 dark:text-blue-300' : 'text-sky-700 dark:text-slate-300'}>
                  {item.service}
                </span>
                <span className={item.highlight ? 'font-bold text-lg text-blue-700 dark:text-blue-300' : 'text-sky-700 dark:text-slate-400 dark:text-slate-400'}>
                  {item.price}/мес
                </span>
              </div>
            ))}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <details
                key={i}
                className="group p-4 bg-sky-100/60 dark:bg-slate-800/30 border border-sky-200 dark:border-slate-700/30 rounded-lg cursor-pointer hover:border-blue-500/30 transition-colors"
              >
                <summary className="flex justify-between items-center font-semibold text-sky-700 dark:text-slate-200">
                  {item.q}
                  <span className="text-2xl group-open:rotate-180 transition-transform">+</span>
                </summary>
                <p className="mt-4 text-sky-700 dark:text-slate-400 dark:text-slate-400">{item.a}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-cyan-600">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-sky-900 dark:text-white mb-4 sm:mb-6">Готовы подключиться?</h2>
          ...
          <button
            onClick={() => navigate('/pricing')}
            className="px-6 sm:px-8 py-3 sm:py-4 bg-sky-50 text-blue-600 font-bold rounded-lg hover:shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 sm:transform sm:hover:scale-110"
          >
            Начать за 10 ₽
          </button>
        </div>
