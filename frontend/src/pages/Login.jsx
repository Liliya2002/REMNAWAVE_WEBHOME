      ...
      <div className="w-full max-w-md">
        <div className="bg-gradient-to-br from-slate-800/40 via-slate-900/50 to-slate-950 border border-slate-700/50 rounded-2xl p-5 sm:p-8 shadow-2xl">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-slate-400">Войдите в свой аккаунт</p>
          </div>
          ...
          <div className="border-t border-slate-700/50 pt-6 mt-6">
            <p className="text-xs text-slate-500 uppercase font-semibold mb-3">После входа вы получите доступ к:</p>
            <ul className="space-y-2 text-sm text-slate-400">
              <li className="flex items-center gap-2">
                <span className="text-cyan-400">✓</span> Личному кабинету
              </li>
              <li className="flex items-center gap-2">
                <span className="text-cyan-400">✓</span> Истории платежей
              </li>
              <li className="flex items-center gap-2">
                <span className="text-cyan-400">✓</span> Управлению подписками
              </li>
            </ul>
          </div>
        </div>
